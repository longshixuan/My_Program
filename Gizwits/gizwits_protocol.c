...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    devStatusPtr->valueCO2 = exchangeBytes(gizY2XFloat(CO2_RATIO,  CO2_ADDITION, dataPoints->valueCO2));     
    devStatusPtr->valuesmoke = exchangeBytes(gizY2XFloat(smoke_RATIO,  smoke_ADDITION, dataPoints->valuesmoke));     
