...
* @{
*/
#define PRODUCT_KEY "8fc64446e57044138555be5587709b41"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c023bede6b9143fbaa60a8fc563e72b7"
...
#define humi_MIN                           0
#define humi_MAX                           100
#define CO2_RATIO                         0.1
#define CO2_ADDITION                      0
#define CO2_MIN                           0
#define CO2_MAX                           50000
#define smoke_RATIO                         0.1
#define smoke_ADDITION                      0
#define smoke_MIN                           0
#define smoke_MAX                           50000
/**@} */
